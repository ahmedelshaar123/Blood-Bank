...
class CategoryController extends Controller
{
    ...
    {
        $this->validate($request, ['title'=>'required'], ['title.required'=>'Title is required']);
    ...
    public function destroy($id)
    {
        ...
        if($record->posts()->count()){
            flash()->error("Can not be deleted, There are " . $record->posts()->count(). " post associated with this category");
            return back();
        }else{
            $record->delete();
