...
@section('content')
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                <a href="{{url(route('post.create'))}}" class="btn btn-primary"><i class="fa fa-plus"></i> Add new post</a>
                        ...
                        <table class="table table-bordered">
                            ...
                            @foreach($records as $record)
                                <tr>
                                    ...
                                    <td class="text-center">{{optional($record->categories->first())->title}}</td>
                                    ...
                                    <td class="text-center">
                                        <a href="{{url(route('post.edit', $record->id))}}" class="btn btn-success btn-xs"><i class="fa fa-edit"></i>Edit</a>
                                    </td>
                                    <td class="text-center">
                                        {!! Form::open([
