                            ...
                            <tbody>
                                @foreach($records as $record)
                                    <tr>
                                        ...
                                        <td class="text text-center">{{$record->title}}</td>
                                        <td class="text text-center">{{$record->body}}</td>
                                        <td class="text text-center">{{optional($record->client)->name}}</td>
                                        <td class="text text-center">{{optional($record->client)->email}}</td>
                                        <td class="text text-center">{{optional($record->client)->phone}}</td>
