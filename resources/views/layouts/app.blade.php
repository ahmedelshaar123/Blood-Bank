                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                ...
                                <a href="{{url('login')}}" onclick="submitSignout()">
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li><a href="{{url(route('client.index'))}}"><i class="fa fa-user"></i> <span>Clients</span></a></li>
                <li><a href="{{url(route('governorate.index'))}}"><i class="ion-ios-home"></i> <span>Governorates</span></a></li>
                <li><a href="{{url(route('city.index'))}}"><i class="ion ion-flag"></i> <span>Cities</span></a></li>
                <li><a href="{{url(route('category.index'))}}"><i class="fa fa-list-alt"></i> <span>Categories</span></a></li>
                <li><a href="{{url(route('post.index'))}}"><i class="fa fa-newspaper-o"></i> <span>Posts</span></a></li>
                <li><a href="{{url(route('contact.index'))}}"><i class="fa fa-envelope"></i> <span>Contacts</span></a></li>
                <li><a href="{{url(route('donation.index'))}}"><i class="fa fa-line-chart"></i> <span>Donations</span></a></li>
                <li><a href="{{url(route('setting.index'))}}"><i class="fa fa-gear"></i> <span>Settings</span></a></li>
                <li><a href="{{url('admin/change-password')}}"><i class="fa fa-lock"></i> <span>Reset password</span></a></li>
